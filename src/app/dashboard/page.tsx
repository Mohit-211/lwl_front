      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6 mb-12">
          {userPackages.length > 0 ? (
            ...
            <p className="text-[#f5f0e8]/70">No active packages</p>
          )}
        </div>
                  ...
                  {/* {video.downloadable && isDirectVideo && (
                    ...
                    <div className="p-4">
                      <a
                        ...
                        className="inline-flex w-full items-center justify-center rounded-md bg-[#c9a227] px-4 py-2 text-[#1a1a2e] font-medium"
                      >
